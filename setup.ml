...
(* OASIS_START *)
(* DO NOT EDIT (digest: 21abf6398201f8e2b30c215780bd6983) *)
(*
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["jls@cs.ucf.edu"];
          homepage = None;
          synopsis = "An implementation of CAM";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "camlex.ml"});
               Executable
                 ({
                     cs_name = "camparse";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "camparse.ml"});
               Executable
                 ({
                     cs_name = "camc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "camc.ml"});
               Executable
                 ({
                     cs_name = "cam";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "cam.ml"})
            ];
          plugins =
